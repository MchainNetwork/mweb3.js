...
class Mweb3 {
   ...
   * @param {string} urlString URL of the blockchain API. eg. http://mchain:mchain@127.0.0.1:13889
   ...
   * @param {number} blocks How many blocks are generated immediately.
   * @param {string} address The address to send the newly generated mcoin to.
   * @param {number} maxTries How many iterations to try (default = 1000000).
   * @return {array} Hashes of blocks generated.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Mchain address.
   * @param {string} address Mchain address
  ...
  /**
   * Converts a hex address to Mchain address.
   * @param {string} hexAddress Mchain address in hex format.
   * @return {Promise} Mchain address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Mchain address.
   * @param {string} address Mchain address to validate.
   ...
   * @param {string} address The Mchain address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the Mchain server.
  ...
  /**
   * Gets the account name associated with the Mchain address.
   * @param {string} address The Mchain address for account lookup.
  ...
  /**
   * Gets the Mchain address based on the account name.
  ...
  /**
   * Gets the Mchain address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Mchain address array or Error.
   */
  ...
  /**
   * Gets a new Mchain address for receiving payments.
   ...
   * @return {Promise} Array of addresses with MAR balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send MAR to.
   * @param {number} amount Amount of MAR to send.
   ...
   * @param {string} senderAddress The MAR address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in MAR/kB.
